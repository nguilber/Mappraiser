PROJECT = Midapack_
VERSION = 1.1b
DIR = /global/homes/d/dbeck/software/midapack
DIRTAR = export_tar
LIBNAME = libmidapack
...
lib: ./src/mapmat/ ./src/toeplitz
	...
	mpicc -fopenmp -shared src/mapmat/mapmat.o src/mapmat/mapmatc.o src/mapmat/bitop.o src/mapmat/als.o src/mapmat/alm.o \
           src/mapmat/csort.o src/mapmat/cindex.o src/mapmat/ring.o src/mapmat/butterfly.o \
           src/toeplitz/toeplitz.o src/toeplitz/toeplitz_seq.o src/toeplitz/toeplitz_block.o \
           src/toeplitz/toeplitz_nofft.o src/toeplitz/toeplitz_gappy.o src/toeplitz/toeplitz_params.o \
           src/toeplitz/toeplitz_rshp.o src/toeplitz/toeplitz_utils.o src/toeplitz/toeplitz_wizard.o obj/templates/templates.o -L/global/cscratch1/sd/dbeck/software/fftw-3.3.7/lib $(LIBMKL) -o ./lib/$(LIBNAME).so
