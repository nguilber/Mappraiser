/**
@file toeplitz_randomblock.c version 1.1b, July 2012
...
int mpi_stbrdmm(double **V, int64_t nrow, int m, int m_rowwise, Block *tpltzblocks, int nb_blocks_local, int nb_blocks_all, int64_t idp, int local_V_size, Flag flag_stgy, int nbsamples, int* sampleIdx)
{
#endif
